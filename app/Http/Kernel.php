...
use App\Http\Middleware\AdminOrGuruWaliKelas;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'kepala_madrasah_or_admin' => \App\Http\Middleware\KepalaMadrasahOrAdmin::class,
        'guru_wali' => \App\Http\Middleware\GuruWali::class,
        'guru_mapel' => \App\Http\Middleware\GuruMapel::class,
        'siswa' => \App\Http\Middleware\Siswa::class,
        'guru_wali_mapel_siswa' => \App\Http\Middleware\GuruWaliMapelSiswa::class,
        'kepala_madrasah_only' => \App\Http\Middleware\KepalaMadrasahOnly::class,
        ...
        'admin_or_guru_wali' => AdminOrGuruWaliKelas::class,
    ];
}
