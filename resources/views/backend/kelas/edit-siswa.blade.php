          ...
          <div class="col-lg-10">
              <div class="card">
                  <div class="card-body">
                      ...
                      <h4 class="card-title">Edit Data Siswa {{ $siswa->nama }} dari kelas {{ $kelas->nama }}</h4>
                      <p class="card-title-desc">Lengkapi form berikut untuk mengubah data Siswa {{ $siswa->nama }}.</p>
                      <form action="{{ route('kelas-update-siswa', [$kelas->id, $siswa->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="date" placeholder="Tanggal lahir siswa" id="tanggal_lahir" name="tanggal_lahir" value="{{ $siswa->tanggal_lahir }}">
                                <div class="mt-2">
                                    @error('tanggal_lahir')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="date" placeholder="Tanggal masuk siswa" id="tanggal_masuk" name="tanggal_masuk" value="{{ $siswa->tanggal_masuk }}">
                                <div class="mt-2">
                                    @error('tanggal_masuk')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
