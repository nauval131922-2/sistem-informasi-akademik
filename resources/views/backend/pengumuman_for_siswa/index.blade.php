...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <form enctype="multipart/form-data" id="formUbahData" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img src="" alt="{{ $pengumuman->nama }}" class="img-thumbnail" width="200"
                                            id="showImage">
                                        <input type="hidden" value="{{ $pengumuman->gambar }}" id="gambarPreview"
                                            name="gambarPreview">
                                    </div>
                                </div>
    ...
    <script>
        ...
        function fetchData() {
            ...
            $.ajax({
                url: '{{ route('pengumuman-for-siswa-fetch') }}',
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    let pengumuman = response.data;
                    $('#judul').val(pengumuman.judul);
                    $('#gambarPreview').val(pengumuman.gambar);
                    $('#showImage').attr('src', pengumuman.gambar);
                    ...
                    $('#isi')[0].value = pengumuman.isi; // isi nilai dari input biasa
                }
        ...
        $('#formUbahData').on('submit', function(e) {
            ...
            $.ajax({
                url: '/pengumuman-for-siswa/update/' + id,
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
