                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('store.blog') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="blog_title" id="short_title" value="">
                                        @error('blog_title')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="blog_tags" id="short_title" value="home,tech" data-role="tagsinput">
                                    </div>
                                </div>
