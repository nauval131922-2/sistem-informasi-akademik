...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('blogs', function (Blueprint $table) {
            ...
            $table->foreignId('blog_category_id')->constrained('blog_categories')->onUpdate('cascade')->onDelete('cascade')->after('blog_image')->nullable();
            ...
            $table->foreignId('id_user_for_blog')->constrained('users')->onUpdate('cascade')->onDelete('cascade')->after('blog_category_id')->nullable();
        });
    }
